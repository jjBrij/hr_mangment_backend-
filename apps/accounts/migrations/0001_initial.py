# Generated by Django 6.0.2 on 2026-06-04 05:22
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'permissions': [('can_view_all_employees', 'Can view all employees'), ('can_edit_all_employees', 'Can edit all employees'), ('can_delete_employees', 'Can delete employees'), ('can_view_payroll', 'Can view payroll'), ('can_process_payroll', 'Can process payroll'), ('can_manage_leave', 'Can manage leave requests'), ('can_view_reports', 'Can view reports')],
            },
            managers=[
